...
F = Fs * F / N;
scf();
subplot(5,2,1); plot2d(y1); title('Time Domain Plot - 16bit/48kHz Sampling Frequency');
subplot(5,2,2); plot2d(F(N/2:N-1), Yt(N/2:N-1)); 
...
F = -(N/2):(-1 + N/2);
F = Fs * F / N;
subplot(5,2,3); plot2d(y2); title('Time Domain Plot - 8bit/48kHz Sampling Frequency');
subplot(5,2,4); plot2d(F(N/2:N-1), Yt(N/2:N-1)); 
...
F = -(N/2):(-1 + N/2);
F = Fs * F / N;
subplot(5,2,5); plot2d(y3); title('Time Domain Plot - 4bit/48kHz Sampling Frequency');
subplot(5,2,6); plot2d(F(N/2:N-1), Yt(N/2:N-1)); 
...
F = -(N/2):(-1 + N/2);
F = Fs * F / N;
subplot(5,2,7); plot2d(y4); title('Time Domain Plot - 2bit/48kHz Sampling Frequency');
subplot(5,2,8); plot2d(F(N/2:N-1), Yt(N/2:N-1)); 
title('Frequency Domain Plot - 2bit/48kHz Sampling Frequency');
a = get("current_axes");
a.data_bounds = [0,min(Yt);24000, max(Yt)];

Yt = 20*log10(%eps+abs(fftshift(fft(y5))));
Yt = Yt / nval;
N = length(Yt);
F = -(N/2):(-1 + N/2);
F = Fs * F / N;
subplot(5,2,9); plot2d(y5); title('Time Domain Plot - 2bit/48kHz Sampling Frequency');
subplot(5,2,10); plot2d(F(N/2:N-1), Yt(N/2:N-1)); 
title('Frequency Domain Plot - 2bit/48kHz Sampling Frequency');
a = get("current_axes");
a.data_bounds = [0,min(Yt);24000, max(Yt)];
